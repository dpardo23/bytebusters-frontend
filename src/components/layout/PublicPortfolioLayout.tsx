...
export function PublicPortfolioLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 border-b border-border/80 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/70">
        <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          <Link to="/" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[linear-gradient(135deg,#38bdf8_0%,#2563eb_100%)] shadow-[0_12px_25px_-15px_rgba(37,99,235,0.75)]">
          ...
          <div className="flex items-center gap-3">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link to="/register">
                  <Button size="sm" className="rounded-xl bg-[linear-gradient(135deg,#38bdf8_0%,#2563eb_100%)] px-5">
                    Crear Cuenta
                  </Button>
                </Link>
              </>
      ...
      <footer className="border-t border-border bg-[#dbeafe]/65 py-14 dark:bg-slate-950">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr]">
            <div>
              <Link to="/" className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[linear-gradient(135deg,#38bdf8_0%,#2563eb_100%)]">
