    ...
    <div className="space-y-6">
      <div className={`bg-white border rounded-xl shadow-sm overflow-hidden text-left transition-colors ${isEditing ? 'border-indigo-200 ring-1 ring-indigo-50' : 'border-gray-200'}`}>
        ...
        <div className="p-6">
          <div className="space-y-2">
            ...
            <textarea
              name="bio" value={formData.bio} onChange={handleChange} disabled={!isEditing} rows={5} placeholder={isEditing ? "Cuentanos sobre ti..." : "Sin informacion"}
      ...
      <div className={`bg-white border rounded-xl shadow-sm overflow-hidden text-left transition-colors ${isEditing ? 'border-indigo-200 ring-1 ring-indigo-50' : 'border-gray-200'}`}>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2 bg-indigo-50 rounded-md"><Briefcase className="w-5 h-5 text-indigo-600" /></div>
